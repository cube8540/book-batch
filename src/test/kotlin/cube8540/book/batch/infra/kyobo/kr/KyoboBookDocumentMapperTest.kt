...
class KyoboBookDocumentMapperTest {
    ...
    fun `document mapping`() {
        ...
        assertThat(result.thumbnail?.largeThumbnail).isEqualTo(URI.create(largeThumbnail))
        assertThat(result.thumbnail?.mediumThumbnail).isEqualTo(URI.create(mediumThumbnail))
