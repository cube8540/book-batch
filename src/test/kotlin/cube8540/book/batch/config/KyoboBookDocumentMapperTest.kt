...
class KyoboBookDocumentMapperTest {
    ...
    fun deserialization(document: Document, expectedBookDetails: ExpectedBookDetails) {
        ...
        assertThat(result.largeThumbnail).isEqualTo(expectedBookDetails.largeThumbnail)
        assertThat(result.mediumThumbnail).isEqualTo(expectedBookDetails.mediumThumbnail)
